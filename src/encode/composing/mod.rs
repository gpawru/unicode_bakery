...
use compositions::CompositionInfo;
...
impl EncodeCodepoint<u64, u32> for EncodeComposition
{
    fn encode(
        &self,
        codepoint: &Codepoint,
